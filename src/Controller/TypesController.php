...
class TypesController extends AppController
{
    ...
    public function initialize() {
        parent::initialize();
        $this->Auth->allow(['getByRestaurant']);
    }
    ...
    public function getByRestaurant() {
        $restaurant_id = $this->request->query('restaurant_id');
    ...
    public function add()
    {
        ...
        $restaurants = $this->Types->Restaurants->find('list', ['limit' => 200]);
        $this->set(compact('type', 'restaurants'));
    }
